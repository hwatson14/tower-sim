...
- [x] Introduce canonical MAX_WAVE runner spine (`python -m tower_sim.run MAX_WAVE --spec fixtures/specs/max_wave.yaml`) with YAML spec + optional overlay patch and latest artifact outputs.
