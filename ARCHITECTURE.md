...
- [x] Introduce canonical MAX_WAVE runner spine (`python -m tower_sim.run.runner --spec tests/fixtures/specs/sample_spec.yaml`) with YAML spec + optional overlay patch and latest artifact outputs.
