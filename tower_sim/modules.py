...
- the module unique-effect library (towersim.modules_library)
- the wiki-derived slot rules (towersim.wiki.module_rules)
...
encoded in `towersim.modules_library`.
"""
...
from .modules_library import (
    Rarity,
    UNIQUE_EFFECTS,
    SUBSTAT_TABLES,
    SubstatCap,
)
from .wiki.module_rules import max_active_substats_for_module_level
