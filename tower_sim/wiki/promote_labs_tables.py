...
LAB_SOURCES = [
    LabSourceSpec(
        source_path="tower_sim/wiki/cache/lab_enemy_attack_level_skip.csv",
        lab_primary_name="Enemy Attack Level Skip",
        level_column="level",
        value_column="value_percent_points",
    ),
    LabSourceSpec(
        source_path="tower_sim/wiki/cache/lab_enemy_health_level_skip.csv",
        lab_primary_name="Enemy Health Level Skip",
        level_column="level",
        value_column="value_percent_points",
    ),
    LabSourceSpec(
        source_path="tower_sim/wiki/cache/lab_health.csv",
        lab_primary_name="Health",
        level_column="Level",
        value_column="Value",
    ),
    LabSourceSpec(
        source_path="tower_sim/wiki/cache/lab_health_regen.csv",
        lab_primary_name="Health Regen",
        level_column="Level",
        value_column="Value",
    ),
    LabSourceSpec(
        source_path="tower_sim/wiki/cache/lab_recovery_package_chance.csv",
        lab_primary_name="Recovery Package Chance",
        level_column="Level",
        value_column="Value",
    ),
    LabSourceSpec(
        source_path="tower_sim/wiki/cache/wall_lab_wall_health.csv",
        lab_primary_name="Wall Health",
        level_column="Level",
        value_column="Value",
    ),
    LabSourceSpec(
        source_path="tower_sim/wiki/cache/wall_lab_wall_regen.csv",
...
def build_labs_values_v1(output_path: Path | None = None) -> Path:
    ...
    if output_path is None:
        output_path = repo_root / "tower_sim" / "tables" / "labs_values_v1.csv"
