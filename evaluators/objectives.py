"""
evaluators/objectives.py -- Objective definitions. AUTHORITY (T10).

Owns: optimisation objective definitions, enhancement state contracts,
objective function parameters, observed run ELS scenarios.

Authority transferred from optimizer/enhancement_state_contracts.py (T10).
optimizer/enhancement_state_contracts.py is now a backward-compat shim.
"""
