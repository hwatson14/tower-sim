...
.module-effect-value{font-weight:800;color:#ffffff;font-size:14px;text-align:right;line-height:1;transform:translateX(-18px);}
.module-effect-label{font-size:14px;font-weight:600;color:#d7dee6;text-align:left;line-height:1.05;transform:translateX(-18px);white-space:nowrap;}
