...
.module-unique{background:rgba(255,255,255,0.035);border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:10px 11px;margin-bottom:10px;min-height:7.5em;max-height:7.5em;overflow-y:auto;font-size:12px;line-height:1.45;color:#d7dee6;box-sizing:border-box;}
