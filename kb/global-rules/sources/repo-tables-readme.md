...
This directory contains deterministic table assets with explicit provenance. Runtime loaders must resolve canonical tables from active KB-owned table surfaces and fail closed when required entries are missing.
