# Modules tables index

Module active tables now prefer concise verified or quantitative tables, with verbose transcriptions archived into history.

## Primary active tables
- `assist-efficiency-upgrade-costs.csv`
- `assist-slot-unlock-costs.csv`
