...
| `out/max_wave_latest.json` + `out/lineage_manifest_latest.json` | `python -m tower_sim.run MAX_WAVE --spec fixtures/specs/max_wave.yaml` | Local run output | Canonical deterministic MAX_WAVE runner spine output payloads. |
