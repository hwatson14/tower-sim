...
9. `boss_time_to_contact_seconds` is an optional manual override. Boss Waves derives the default contact time from a 2s base plus QE-owned Chrono Field slow, Energy Net duration, and Slow Aura enemy-speed reduction.
